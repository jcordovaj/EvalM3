...
Historial de versiones para consola:
    ...
    2.0.1 (19/08/2024): Corrige errores de refresco de pantalla y manejo del menú
    3.1.0 (20/08/2024): Agrega ingesta de datos desde un archivo externo ".txt", muestra las 4 opciones básicas.
